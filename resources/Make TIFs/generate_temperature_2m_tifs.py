#!/usr/bin/env python3
"""Generate temperature_2m.tif GeoTIFFs by interpolating weather data to a 100m grid.
...
The output structure is::
    ...
    TIFS/100m_resolution/<timestamp>/temperature_2m.tif
...
def main():
    ...
    for ts in TIMESTAMPS:
        ...
        out_path = os.path.join(out_dir, "temperature_2m.tif")
